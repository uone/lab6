...
export const mockRecipes: Recipe[] = [
  ...
  },
  {
    ...
    description: 'Соковиті вареники з літньою вишнею. Подаються зі сметаною та цукром.',
  ...
  },
  {
    ...
    description: 'Ніжна котлета з маслом всередині. Хрустка скоринка та соковите м\'ясо.',
  ...
  },
  {
    ...
    description: 'Класичний салат Цезар з хрусткими грінками та сиром.',
  ...
  },
  {
    ...
    description: 'Свіжий салат з фетою та оливками. Легкий та корисний.',
  ...
  },
  {
    ...
    description: 'Ніжний крем-суп з гарбуза з імбирем та вершками.',
  ...
  },
  {
    ...
    description: 'Італійська паста з кремовим соусом та хрустким беконом.',
